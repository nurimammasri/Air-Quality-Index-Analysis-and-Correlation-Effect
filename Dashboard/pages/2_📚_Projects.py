...
pdf = os.getcwd()+'/docs/portfolio.pdf'
st.markdown(f"""
<iframe src="https://docs.google.com/viewer?srcid=1UdXtGNRX1KC-qqIakEDLgxnm7V6heHa7&pid=explorer&efh=false&a=v&chrome=false&embedded=true" width="1300" height="650"></iframe>
""", unsafe_allow_html=True)
